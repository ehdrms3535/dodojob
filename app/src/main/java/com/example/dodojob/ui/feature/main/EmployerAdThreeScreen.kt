...
@Composable
fun EmployerAdThreeScreen(nav: NavController) {
    val url = "https://newploy.net/"
    ...
    Scaffold(
        ...
        bottomBar = {
            Column(
                ...
                Button(
                    ...
                    Text("뉴플로이 더 알아보기", fontSize = 18.sp)
                }
        ...
        Column(
            ...
            Image(
                painter = painterResource(R.drawable.employer_main_ad3),
