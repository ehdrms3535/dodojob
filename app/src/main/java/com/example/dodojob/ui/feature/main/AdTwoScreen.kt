...
@Composable
fun AdTwoScreen(nav: NavController) {
    val url =
        "https://www.figma.com/exit?url=https%3A%2F%2Femart.ssg.com%2Fitem%2F..."

    Scaffold(
        containerColor = Color(0xFFEDEDF8),
        topBar = { AdTopBar(nav) },
        bottomBar = {
            Column(
                ...
                // 버튼 24sp
                OpenUrlButton("안구 건강 영양제 보러가기", url)
        ...
        Column(
            ...
            Image(
                painter = painterResource(R.drawable.main_ad2),
