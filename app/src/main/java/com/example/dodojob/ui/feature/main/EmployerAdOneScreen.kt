...
@Composable
fun EmployerAdOneScreen(nav: NavController) {
    val url = "https://www.ei.go.kr/ei/eih/cm/hm/main.do"
    ...
    Scaffold(
        ...
        bottomBar = {
            Column(
                ...
                Button(
                    ...
                    Text("고용24에서 바로 신청하기", fontSize = 18.sp)
                }
        ...
        Column(
            ...
            Image(
                painter = painterResource(R.drawable.employer_main_ad1),
